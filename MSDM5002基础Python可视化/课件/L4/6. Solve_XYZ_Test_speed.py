...
"""
@author: Junwei Liu
Test the speed of different functions by running it repeatedly
"""
import time
import numpy as np
...
#do the power calculations in advance since it will take some time
...
def func_check10(xx,yy,zz):
    ...
    XY=MX[...,np.newaxis]+MY  #The ellipsis ... means as many : as needed.
