 ...
 title1 'Demand of Electricity: 15th day of every month month, 1972-1993';
...
CARDS;
  ...
  10.05980
   ...
   run;
     ...
     identify var=xlog;     
     identify var=xlog(1,12) nlag=18;      
	  ...
	  run;
      forecast out=b lead=24  noprint;
   quit;
   ...
   symbol3 i=join  v=circle;
      title1 'Forecasting for Demand of Electricity: 15th day of every month month';
