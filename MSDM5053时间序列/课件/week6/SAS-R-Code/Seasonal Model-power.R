...
w1=diff(lgAP)
plot(w1,xlab=" ",ylab=" ",main="w1 ",type="l",col="red",ylim=c(-0.05,0.05))

w2=diff(lgAP,12)
plot(w2,xlab=" ",ylab=" ",main="w2 ",type="l",col="red",ylim=c(-0.05,0.05))

w3=diff(diff(lgAP,12))
plot(w3,xlab=" ",ylab=" ",main="w3 ",type="l",col="red",ylim=c(-0.05,0.05))
